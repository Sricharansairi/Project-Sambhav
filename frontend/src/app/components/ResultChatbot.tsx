                ...
                <div className="flex gap-1 items-center h-4">
                  {[0,0.2,0.4].map((d, i) => (
                    <motion.div key={i} animate={{ opacity: [0.3, 1, 0.3] }} transition={{ repeat: Infinity, duration: 1.2, delay: d }}
                      className="w-1.5 h-1.5 rounded-full bg-[#ffb7c5]/60" />
                  ))}
                </div>
              </div>
            </motion.div>
        ...
        <div className="px-4 py-3 border-t border-white/10">
          <div className="flex gap-2 items-end">
            ...
            <motion.button
              ...
              className="flex-shrink-0 w-9 h-9 rounded-xl bg-[#ffb7c5] flex items-center justify-center disabled:opacity-40 transition-all"
            >
