    ...
    <div className="mt-8 p-6 rounded-2xl bg-[#08080c] border border-white/10 text-muted-foreground space-y-6">
      <div className="flex items-center gap-3 border-b border-white/10 pb-4">
        ...
        <div>
          ...
          <p className="text-xs uppercase tracking-widest text-[#c0c0c0]/80 font-semibold">Technical Architecture & Methodology Guide</p>
        </div>
      </div>

      <div className="prose prose-invert prose-sm max-w-none text-xs leading-relaxed space-y-6">
        <section>
          <h3 className="text-sm font-semibold text-white flex items-center gap-2 mb-2"><Brain className="w-4 h-4 text-[#c0c0c0]" /> 1. Introduction to PRAGMA</h3>
          <p>
        ...
        <section>
          <h3 className="text-sm font-semibold text-white flex items-center gap-2 mb-2"><Activity className="w-4 h-4 text-[#c0c0c0]" /> 2. Core Methodologies: The Deception Detection Matrix</h3>
          <p>
        ...
        <section>
          <h3 className="text-sm font-semibold text-white flex items-center gap-2 mb-2"><FileSearch className="w-4 h-4 text-[#c0c0c0]" /> 3. The 8-Dimension Cognitive Audit</h3>
          <p>
        ...
        <section>
          <h3 className="text-sm font-semibold text-white flex items-center gap-2 mb-2"><Eye className="w-4 h-4 text-[#c0c0c0]" /> 4. Actionable Intervention & Interview Strategy</h3>
          <p>
        ...
        <section>
          <h3 className="text-sm font-semibold text-white flex items-center gap-2 mb-2"><Database className="w-4 h-4 text-[#c0c0c0]" /> 5. Deep Learning Architecture</h3>
          <p>
